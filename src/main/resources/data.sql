...
INSERT INTO Office (id, version, org_id, office_name, address, phone, is_active) VALUES (2, 0, 1, 'Долгопрудный', 'г. Долгопрудный, Лихачевский проспект, д.18, стр.1', '74995037363', true);
...
INSERT INTO Worker (id, version, office_id, first_name, position_value, citizenship_code, is_identified) VALUES (2, 0, 1, 'Александр', 'Управляющий', 2, true);
